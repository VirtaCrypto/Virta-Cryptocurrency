...
const string strMessageMagic = "Virta Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Virta", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Virta 1473109085";
        CTransaction txNew;
        txNew.nTime = 1473109085;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xf01908e4e7f41e0a36d19b973499607b53b013471cc14fe80c4a1750d96d6e36"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0x11, 0xa2, 0xb2 };
